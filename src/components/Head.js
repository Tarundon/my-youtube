...
const Head = () => {
  ...
  useEffect(() => {
    ...
    //but the difference btw 2 api calls is <200ms
    ...
    <div className="grid grid-flow-col m-2  p-2 shadow-lg  ">
      <div className=" flex col-span-1 ">
        <img
          ...
          alt="menu"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8pOS7TcX0xubbdPXkz19N0RR5Wlqb_xXObQ&usqp=CAU"
        />
        <a href="/">
          <img
      ...
      <div className="col-span-10  px-10  ">
        <input
          className="px-5 w-1/2 border border-gray-400 py-1  rounded-l-full"
          type="text"
          value={searchQuery}
        ...
        />
        <button className="border border-gray-400 px-3 py-1  rounded-r-full bg-gray-100">
          search
        </button>
       
        {showSuggestions && (
        <div
          className="absolute bg-white  px-2 border border-gray-100 w-[30rem] shadow-lg rounded-lg
      ...
      <div className="col-span-1">
        <img
          className="h-6"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuGUniJu7LdeRX1UyMtVWCWEhAGvtEe4mrzg&usqp=CAU"
          alt="profile"
        />
      </div>
    </div>
